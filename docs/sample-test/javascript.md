...
Open this file with MD Code Assist installed, then press `Shift+Alt+F` to format all blocks,
or place your cursor inside a block and run **MD Code Assist: Format Current Code Block**.
